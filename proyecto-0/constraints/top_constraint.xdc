...
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports {B[4]}]

## Switches para ALUControl
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports {ALUControl[0]}]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports {ALUControl[1]}]
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports {ALUControl[2]}]

## Switches para bshift
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports {bshift[0]}]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {bshift[1]}]
...
## LEDs para ALUFlags 
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports {ALUFlags[0]}]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports {ALUFlags[1]}]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports {ALUFlags[2]}]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports {ALUFlags[3]}]
